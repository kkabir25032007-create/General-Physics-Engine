...
class Dynamics(Physics):
    ...
    def particle_colllision(self, other, unit_body_normal):
        ...
        if distance_squared > radius_sum * radius_sum:
            return  # pair culling: spheres don't touch
        if distance_squared == 0:
            return  # coincident centres: no collision normal
        self.distance_between_centre = abs(displacement)
        self.unit_body_normal = displacement / self.distance_between_centre
        ...
        penetration = radius_sum - self.distance_between_centre
